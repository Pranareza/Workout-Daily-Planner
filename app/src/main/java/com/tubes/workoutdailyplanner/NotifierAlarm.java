...
public class NotifierAlarm extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        taskStackBuilder.addParentStack(SetReminder.class);
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            channel = new NotificationChannel("Workout Daily Planner","hello", NotificationManager.IMPORTANCE_HIGH);
        }
        ...
        Notification notification = builder.setContentTitle("Reminder")
                ...
                .setChannelId("Workout Daily Planner")
                .build();
